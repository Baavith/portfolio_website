...
export default function Hero() {
  ...
  return (
    <section id="about" style={{
      ...
      {/* Blobs */}
      <div style={{ position:"absolute", top:"-20%", left:"-10%", width:"600px", height:"600px", background:"radial-gradient(circle, rgba(131,56,236,0.18) 0%, transparent 70%)", borderRadius:"50%", zIndex:0, pointerEvents:"none" }} />
      <div style={{ position:"absolute", bottom:"-10%", right:"-5%", width:"500px", height:"500px", background:"radial-gradient(circle, rgba(6,214,160,0.12) 0%, transparent 70%)", borderRadius:"50%", zIndex:0, pointerEvents:"none" }} />
      <div style={{ position:"absolute", top:"30%", right:"15%", width:"400px", height:"400px", background:"radial-gradient(circle, rgba(255,0,110,0.1) 0%, transparent 70%)", borderRadius:"50%", zIndex:0, pointerEvents:"none" }} />
      ...
      <div style={{ position:"relative", zIndex:1, width:"100%", maxWidth:"1000px" }}>
        ...
        <div style={{
          ...
          <div style={{ flex:1, minWidth:"280px", textAlign:"left" }}>
            ...
            <div style={{
              ...
              <span style={{ color:"rgba(255,255,255,0.4)" }}>I'm an</span>
              <span style={{
            ...
            <div style={{ display:"flex", gap:"16px", flexWrap:"wrap" }}>
              ...
              <a href={`mailto:${personal.email}`} style={{
                ...
                borderRadius:"100px", fontSize:"0.95rem",
        ...
        <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:"8px" }}>
          ...
          <div style={{ width:"24px", height:"40px", border:"1.5px solid rgba(255,255,255,0.15)", borderRadius:"12px", display:"flex", alignItems:"flex-start", justifyContent:"center", padding:"5px" }}>
            <div style={{ width:"4px", height:"8px", background:"rgba(131,56,236,0.7)", borderRadius:"4px", animation:"scrollDown 1.5s ease infinite" }} />
          </div>
        </div>
      </div>
